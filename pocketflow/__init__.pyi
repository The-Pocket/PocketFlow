...
class Node(BaseNode[_PrepResult, _ExecResult, _PostResult]):
    ...
    def __init__(self, max_retries: int = 1, wait: Union[int, float] = 0, node_id: Optional[str] = None) -> None: ...
...
class Flow(BaseNode[_PrepResult, Any, _PostResult]):
    ...
    nodes: Dict[str, 'BaseNode[Any, Any, Any]']
    
    def __init__(self, start: Optional['BaseNode[Any, Any, Any]'] = None, node_id: Optional[str] = None) -> None: ...
    def start(self, start: 'BaseNode[Any, Any, Any]') -> 'BaseNode[Any, Any, Any]': ...
    def _discover_nodes(self) -> 'Flow[Any, Any, Any]': ...
    def get_next_node(
        self, curr: 'BaseNode[Any, Any, Any]', action: Optional[str]
    ) -> Optional['BaseNode[Any, Any, Any]']: ...
    def _orch(
        self, shared: SharedData, params: Optional[Params] = None, resume_info: Optional[ResumeInfo] = None
    ) -> Any: ...
    def _run(self, shared: SharedData) -> _PostResult: ...
    def resume(self, shared: SharedData, resume_info: ResumeInfo) -> _PostResult: ...
...
class AsyncFlow(Flow[_PrepResult, Any, _PostResult], AsyncNode[_PrepResult, Any, _PostResult]):
    ...
    async def _run_async(self, shared: SharedData) -> _PostResult: ...
    async def resume_async(self, shared: SharedData, resume_info: ResumeInfo) -> _PostResult: ...
    async def post_async(
